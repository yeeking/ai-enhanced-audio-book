...
{
//   std::string modelFolder {"/Users/matthewyk/src/ai-audio-book/ai-audio-book-code/src/Part4_NeuralFX/037b_trained-lstm-JUCE/"};  
//   std::string modelFolder {"/home/matthewyk/src/ai-enhanced-audio/ai-audio-book-code/src/Part4_NeuralFX/037a_train_lstm/python/"};
  std::string modelFolder {"C:\\Users\\matthewyk\\src\\ai-audio-book\\ai-audio-book-code\\src\\Part4_NeuralFX\\037b_trained-lstm-JUCE\\models\\"};
...
void AudioPluginAudioProcessor::processBlockNN(  torch::jit::script::Module& model, 
