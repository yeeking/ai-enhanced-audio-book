...
public:
    ...
    juce::AudioProcessorEditor* getHostedPluginEditor();
    int countValidParameters();
    std::vector<float> getHostedPluginParamValues();
    void setHostedPluginParamValues(std::vector<float> values);
