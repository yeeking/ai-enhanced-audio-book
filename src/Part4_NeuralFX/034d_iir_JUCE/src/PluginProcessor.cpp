...
#endif
{
    // // IIRCoefficients::makeHighPass(getSampleRate(), 500)
    // auto& filter = processorChain.get<0>();
    // filter.coefficients = juce::dsp::IIR::Coefficients<float>::makeLowPass(getSampleRate(), 500);
